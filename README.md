...
<p>Update your local env with the following <a href="/fnproject/tutorials/blob/oci-py-example/python/cloud/oracle/oci-instances-func/setup_local.sh">script</a>.</p>
